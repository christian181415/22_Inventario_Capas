<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DetallesComponente.aspx.cs" Inherits="CapaPresentacion.DetallesComponente" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <title>Detalles Componentes</title>
</head>
    ...
    <form id="form1" runat="server">
        <div class="contenedor">
            <center>
                ...
                <h1 style="background-color:#808080">[DETALLES COMPONENTES]</h1>
            ...
            <div>
                <center>
                    ...
                    <br />
                    <asp:Label ID="Label12" runat="server" BackColor="#99CCFF" Text="Num Serie:"></asp:Label>
                    <br />
